...
windowClose : SFColor.Color -> Int -> Element.Element msg
windowClose cl size =
    Element.el [] <|
        Element.html <|
...
windowClose_ : SFColor.Color -> Int -> Html.Html msg
windowClose_ cl size =
    Svg.svg
...
bell : SFColor.Color -> Int -> Element.Element msg
bell cl size =
    Element.el [] <|
        Element.html <|
            bell_ cl size
...
bell_ : SFColor.Color -> Int -> Html.Html msg
bell_ cl size =
    Svg.svg
...
question : SFColor.Color -> Int -> Element.Element msg
question cl size =
    Element.el [] <|
        Element.html <|
            question_ cl size
...
question_ : SFColor.Color -> Int -> Html.Html msg
question_ cl size =
    Svg.svg
        [ SA.viewBox "0 0 1792 1792"
        , SA.height <| String.fromInt size
...
downArrow : SFColor.Color -> Int -> Element.Element msg
downArrow cl size =
    Element.el [] <|
        Element.html <|
            downArrow_ cl size
...
downArrow_ : SFColor.Color -> Int -> Html.Html msg
downArrow_ cl size =
    Svg.svg
        [ SA.viewBox "0 0 1792 1792"
        , SA.height <| String.fromInt size
...
upArrow : SFColor.Color -> Int -> Element.Element msg
upArrow cl size =
    Element.el [] <|
        Element.html <|
            upArrow_ cl size
...
upArrow_ : SFColor.Color -> Int -> Html.Html msg
upArrow_ cl size =
    Svg.svg
        [ SA.viewBox "0 0 1792 1792"
        , SA.height <| String.fromInt size
...
rightArrow : SFColor.Color -> Int -> Element.Element msg
rightArrow cl size =
    Element.el [] <|
        Element.html <|
            rightArrow_ cl size
...
rightArrow_ : SFColor.Color -> Int -> Html.Html msg
rightArrow_ cl size =
    Svg.svg
        [ SA.viewBox "0 0 1792 1792"
        , SA.height <| String.fromInt size
...
remove : SFColor.Color -> Int -> Element.Element msg
remove cl size =
    Element.el [] <|
        Element.html <|
            remove_ cl size
...
remove_ : SFColor.Color -> Int -> Html.Html msg
remove_ cl size =
    Svg.svg
...
copyToClipboard_ : SFColor.Color -> Int -> Html.Html msg
copyToClipboard_ cl size =
...
timesCircle : SFColor.Color -> Int -> Element.Element msg
timesCircle cl size =
    Element.el [] <|
        Element.html <|
...
timesCircle_ : SFColor.Color -> Int -> Html.Html msg
timesCircle_ cl size =
    Svg.svg
...
lock : SFColor.Color -> Int -> Element.Element msg
lock cl size =
    Element.el [] <|
        Element.html <|
            lock_ cl size
...
lock_ : SFColor.Color -> Int -> Html.Html msg
lock_ cl size =
    Svg.svg
        [ SA.viewBox "0 0 1792 1792"
        , SA.height <| String.fromInt size
...
unlock : SFColor.Color -> Int -> Element.Element msg
unlock cl size =
    Element.el [] <|
        Element.html <|
            unlock_ cl size
...
unlock_ : SFColor.Color -> Int -> Html.Html msg
unlock_ cl size =
    Svg.svg
        [ SA.viewBox "0 0 1792 1792"
        , SA.height <| String.fromInt size
...
lockOpen : SFColor.Color -> Int -> Element.Element msg
lockOpen cl size =
    Element.el [] <|
        Element.html <|
            lockOpen_ cl size
...
lockOpen_ : SFColor.Color -> Int -> Html.Html msg
lockOpen_ cl size =
    Svg.svg
        [ SA.viewBox "0 0 1792 1792"
        , SA.height <| String.fromInt size
