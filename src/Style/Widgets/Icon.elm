...
question : Element.Color -> Int -> Element.Element msg
question cl size =
    Element.el [] <|
        Element.html <|
            question_ cl size
...
question_ : Element.Color -> Int -> Html.Html msg
question_ cl size =
    Svg.svg
        [ SA.viewBox "0 0 1792 1792"
        , SA.height <| String.fromInt size
...
downArrow : Element.Color -> Int -> Element.Element msg
downArrow cl size =
    Element.el [] <|
        Element.html <|
            downArrow_ cl size
...
downArrow_ : Element.Color -> Int -> Html.Html msg
downArrow_ cl size =
    Svg.svg
        [ SA.viewBox "0 0 1792 1792"
        , SA.height <| String.fromInt size
...
upArrow : Element.Color -> Int -> Element.Element msg
upArrow cl size =
    Element.el [] <|
        Element.html <|
            upArrow_ cl size
...
upArrow_ : Element.Color -> Int -> Html.Html msg
upArrow_ cl size =
    Svg.svg
        [ SA.viewBox "0 0 1792 1792"
        , SA.height <| String.fromInt size
...
rightArrow : Element.Color -> Int -> Element.Element msg
rightArrow cl size =
    Element.el [] <|
        Element.html <|
            rightArrow_ cl size
...
rightArrow_ : Element.Color -> Int -> Html.Html msg
rightArrow_ cl size =
    Svg.svg
        [ SA.viewBox "0 0 1792 1792"
        , SA.height <| String.fromInt size
...
unlock : Element.Color -> Int -> Element.Element msg
unlock cl size =
    Element.el [] <|
        Element.html <|
            unlock_ cl size
...
unlock_ : Element.Color -> Int -> Html.Html msg
unlock_ cl size =
    Svg.svg
        [ SA.viewBox "0 0 1792 1792"
        , SA.height <| String.fromInt size
