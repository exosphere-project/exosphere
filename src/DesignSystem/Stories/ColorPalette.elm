...
> Note: This must be used only when ExoPalette can't cater to your needs. Should you choose to use it, you should be aware that the color shade will remain same in both light and dark theme. In most of such scenarios, you might want to add a new field in ExoPalette that can adapt to both light and dark theme.
